...
g2
png(filename = paste0(dir.out,"/ML2_OrderPlot_labels_bars_Mean_r_02-09-2017.png"),width=2400,height=2177, res=250)
g2
dev.off()
...
g3
 png(filename = paste0(dir.out,"/ML2_OrderPlot_labels_bars_Global_r_02-09-2017.png"),width=2400,height=2177, res=250)
 g3
 dev.off()
